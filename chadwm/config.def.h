...
/* tagging */
// static char *tags[] = { "󰎤","󰎧","󰎪","󰎭","󰎱"};
static char *tags[] = { "󰎤 : 󰞷", "󰎧 : 󰨞", "󰎪 : 󰀶", "󰎭 : 󰈹", "󰎱 : 󱓥"};

static const char* rofilauncher[] = { "launcher-nord", NULL };
...
static const Rule rules[] = {
    ...
    { "kitty",    NULL,       NULL,       1,            0,           0,           -1 }, // 1st tag
    { "Emacs",    NULL,       NULL,       2,            0,           0,           -1 }, // 2nd tag
    { "Pcmanfm",  NULL,       NULL,       1 << 2,       0,           0,           -1 }, // 3th tag
    { "firefox",  NULL,       NULL,       1 << 3,       0,           0,           -1 }, // 4th tag
    { "obsidian", NULL,       NULL,       1 << 4,       0,           0,           -1 }, // 5th tag
...
static Key keys[] = {
    ...
    { MODKEY,                           XK_r,       spawn,            SHCMD("launcher-nord") },
    { MODKEY,                           XK_Return,  spawn,            SHCMD("kitty -c /home/kvl/.config/kitty/kitty-nord.conf")},
    { MODKEY|ShiftMask,                           XK_w,       spawn,            SHCMD("firefox")},
    { MODKEY|ShiftMask,                           XK_e,       spawn,            SHCMD("emacs")},
    { MODKEY|ShiftMask,                           XK_o,       spawn,            SHCMD("/home/kvl/Applications/Obsidian-0.15.9.AppImage")},
